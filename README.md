...
数値計算に関連するリンク集を作成しました. おすすめのリンクがあったら[こちら](https://github.com/ohno/Links/issues)で教えてください.
...
### 研究費
- [学振](https://www.jsps.go.jp/j-pd/)
- [ACT-X](https://www.jst.go.jp/kisoken/act-x/index.html)
...
- [Reactテンプレート](https://material-ui.com/store/?utm_source=docs&utm_medium=referral&utm_campaign=home-store)
- [Bootstrapテンプレート](https://getbootstrap.jp/docs/5.0/examples/)
